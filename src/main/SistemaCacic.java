...
public class SistemaCacic {
	...
	public  static void addParticipante(int dni,String name,String apellido,String lugarDeTrabajo,int tema) throws ClientProtocolException, IOException {
		...
		ObjectMapper mapper = new ObjectMapper();
		Tema tema01=mapper.readValue(resultContent1, Tema.class);
		Tema tema02=mapper.readValue(resultContent2, Tema.class);
		Usuario user=new Usuario();
		user.setId(dni);
		user.setNombre(name);
		user.setApellido(apellido);
		user.setLugarDeTrabajo(lugarDeTrabajo);
		user.addTemasConocimiento(tema01);
		user.addTemasConocimiento(tema02);
